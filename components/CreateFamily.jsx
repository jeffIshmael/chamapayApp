  ...
  return (
    <View >
      <View style={styles.form}>
        ...
        <View style={styles.inputContainer}>
          {/* <Text style={styles.label}>Amount (in cKes)</Text> */}
          <TextInput
      ...
      {showTimePicker && (
        ...
        <View style={styles.inputContainer}>
          {/* <Text style={styles.label}>Cycle Time (in days)</Text> */}
          <TextInput
        ...
        <TouchableOpacity onPress={handleSubmit} disabled={isPending} style={isPending ? styles.buttonDisabled : styles.button}>
          {isPending ? (
...
const styles = StyleSheet.create({
  ...
  form: {
    ...
    shadowRadius: 10,
    elevation: 5,
    width: '90%', // Adjust the width to occupy most of the screen
    alignSelf: 'center',
  },
  inputContainer: {
    flexDirection: 'row',
